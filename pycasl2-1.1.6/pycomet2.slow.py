...
class pyComet2:
    ...
    def initialize(self):
    	class MyList:
    		def __init__(self, weight, *args, **keywords):
    			self.l = array.array(*args, **keywords)
    			self.w = weight
        ...
        self.memory = MyList(0.0001, 'H', [0]*65536) # 主記憶 1 word = 2 byte unsigned short
        self.GR = MyList(0.00001, 'H', [0]*9) # レジスタ unsigned short
